...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Photographer Studio</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Services provided by Anak Bumi Studio.</h3>
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <ul class="list-inline social-buttons">
                            ...
                            <li><a href="http://penselpatahpicture.blogspot.com/"><i class="fa fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Make Booking</h2>
                    <h3 class="section-subheading text-muted">Please sign in to make a booking.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" name="formLogin" id="formLogin" action="<?=site_url('welcome/login')?>" method="POST">
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control" placeholder="Username" name="loginname" type="username" required="" autofocus="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
